...
import com.madhabdhakal.dropbox.examples.android.CallBack;
...
public abstract class UploadImageFromDB extends AsyncTask implements CallBack {
    ...
    protected UploadImageFromDB(DbxClientV2 dbxClient, File file, Context context, int a) {
    ...
    protected Object doInBackground(Object[] objects) {
        try {
            ...
            dbxClient.files().uploadBuilder("/" + "_" + file.getName())
